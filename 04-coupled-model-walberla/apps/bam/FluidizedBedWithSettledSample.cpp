//
// Created by mohammad sanayei on 11.08.22.
//
...
/////////////////////////////////////
    ...
    public:
        ...
        Type * operator()( IBlock* const block, const StructuredBlockStorage* const storage ) const
        {
            ...
            //for(auto item : domainBB ){
            //WALBERLA_LOG_INFO_ON_ROOT("domainBB " << item << " !!!");
            //}
            ...
            WALBERLA_LOG_INFO_ON_ROOT("domainBB.xMin()" << domainBB.xMin() << " !!!");
            WALBERLA_LOG_INFO_ON_ROOT("domainBB.xMax() " << domainBB.xMax() << " !!!");
            WALBERLA_LOG_INFO_ON_ROOT("domainBB.zMin() " << domainBB.zMin() << " !!!");
            WALBERLA_LOG_INFO_ON_ROOT("domainBB.zMax() " << domainBB.zMax() << " !!!");
            WALBERLA_LOG_INFO_ON_ROOT("domainBB.yMin() " << domainBB.yMin() << " !!!");
            WALBERLA_LOG_INFO_ON_ROOT("domainBB.yMax() " << domainBB.yMax() << " !!!");
